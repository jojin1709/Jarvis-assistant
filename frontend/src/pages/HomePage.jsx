    ...
    <div className="grid min-h-0 grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1fr)_360px]">
      <div className="flex min-w-0 flex-col gap-4">
        <CoreStage
          ...
          onSuggestion={runtime.runTextFlow}
        />
        ...
        <section className="panel rounded-[28px] p-5">
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-textSecondary">Frequent actions for fast desktop work.</p>
            </div>
          </div>
          <QuickDock
            ...
            onUploadClick={() => runtime.setActivePage("files")}
          />
        </section>
      </div>
      ...
      <aside className="flex min-w-0 flex-col gap-4">
        <section className="panel rounded-[28px] p-5">
          <h2 className="mb-4 text-base font-semibold text-textPrimary">System overview</h2>
        ...
        <section className="panel rounded-[28px] p-5">
          <div className="mb-4 flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="grid h-9 w-9 place-items-center rounded-xl border border-line bg-white/[0.035] text-textSecondary hover:text-textPrimary"
            >
              <Camera size={16} />
            </button>
          </div>
          <p className="text-sm text-textSecondary">{runtime.vision?.summary || "Capture the screen to let Jarvis inspect visible UI state."}</p>
        </section>

        <section className="panel rounded-[28px] p-5">
          <h2 className="mb-4 text-base font-semibold text-textPrimary">Live thinking</h2>
          <ThinkingTimeline items={runtime.thinkingTimeline} compact />
        </section>

        <section className="panel rounded-[28px] p-5">
          <h2 className="mb-4 text-base font-semibold text-textPrimary">Smart suggestions</h2>
          <div className="space-y-2">
            {suggestions.map((suggestion) => (
              <button
                ...
                className="w-full rounded-2xl border border-line bg-white/[0.025] p-3 text-left text-sm text-textSecondary transition hover:bg-white/[0.055] hover:text-textPrimary disabled:opacity-45"
              >
                {suggestion}
              </button>
            ))}
        ...
        <section className="panel rounded-[28px] p-5">
          <h2 className="mb-4 text-base font-semibold text-textPrimary">Execution logs</h2>
  ...
  return (
    <div className="rounded-2xl border border-line bg-white/[0.025] p-3">
      <div className="flex items-center gap-3">
        <div className="grid h-9 w-9 place-items-center rounded-2xl bg-cyanCore/10 text-cyanCore">
          <Icon size={17} />
        </div>
        <div>
